package com.hyperaccess.gestiondiplome.validator;
...
public class ObjectsValidator<T> {
    ...
    public void  validate(T objectsToValidate) {
        ...
        if (!violations.isEmpty()){
            ...
            throw new ObjectsValidationException(errorMessages,objectsToValidate.getClass().getName());
        }
    }
}
